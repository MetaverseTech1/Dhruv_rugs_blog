      ...
      <div className="pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <form onSubmit={handleSubmit} className="max-w-2xl mx-auto bg-white p-12 border border-gray-200 animate-fade-in-up">
            ...
            <button
              type="submit"
              className="w-full px-8 py-4 bg-gray-900 text-white font-medium tracking-widest uppercase text-[13px] md:text-sm transition-all duration-300 hover:bg-primary-500"
            >
              Send Message
            </button>
          </form>
